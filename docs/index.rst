...
:ref:`sec-quickstart` covers how to set up an R&D decision context using Tyche by creating the necessary input datasets and writing the technology model. :ref:`sec-techmodelexample` provides a simple example of developing a technology model, and :ref:`sec-analysisexample` provides an analysis example of decision support analysis. High-level information on the approach behind Tyche is given in :ref:`sec-approach` and details on the mathematical formulation used to represent technologies and analyze investment impact is given in :ref:`sec-formulation`. :ref:`sec-optimizers` gives information on built-in optimization algorithms. The complete Python API for the Tyche codebase and the technology models provided with Tyche is in :ref:`sec-modules`.

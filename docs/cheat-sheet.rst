...
Within each Technology folder there is one Jupyter (.ipynb) analysis notebook file that models the technology and seven .csv files to provide data, as follow:
